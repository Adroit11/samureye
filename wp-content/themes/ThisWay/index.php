...
<div id="body-wrapper">
	...
	<div id="footer">
		...
		<div id="bgControl">
			...
			<a class="next" href="javascript:void(0);" onclick="nextBg()"></a>			<a class="soundicon" href="javascript:void(0);" onclick="videoMute()"></a>			<a class="soundmute" href="javascript:void(0);" onclick="videoUnMute()"></a>
		</div>
