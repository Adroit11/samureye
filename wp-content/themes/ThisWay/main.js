...
function videoMute(){	if(activePlayer=='youtube')		ytplayer.mute();	else if(activePlayer=='vimeo')		$f(vmplayer).api('setVolume',0);	else if(activePlayer=='jwplayer')		jwplayer('jwP').setMute(true);	videoMuted=true;	$('#bgControl .soundmute').show();	$('#bgControl .soundicon').hide();}function videoUnMute(){	$('#bgControl .soundmute').hide();	$('#bgControl .soundicon').show();		if(activePlayer=='youtube')		ytplayer.unMute();	else if(activePlayer=='vimeo')		$f(vmplayer).api('setVolume',1);	else if(activePlayer=='jwplayer')		jwplayer('jwP').setMute(false);	videoMuted=false;}
